      ...
      <div className="w-full max-w-sm mx-auto">
        <div className="bg-[#1a2332] border border-[#2a3a4e] rounded-xl p-8">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <span className="text-xl font-bold text-white">Admin Login</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-orange-500 px-4 py-2.5 font-medium text-white hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-[#1a2332] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
