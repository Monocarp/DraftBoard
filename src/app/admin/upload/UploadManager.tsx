...
const DATA_TYPES_UNSORTED: Record<DataType, DataTypeConfig> = {
  ...
  nfl_profiles: {
    ...
    requiredColumns: [
      ...
      { key: "production_score", label: "Production Score", required: false },
      { key: "production_score_rank", label: "Production Score Rank", required: false },
      { key: "athleticism_score", label: "Athleticism Score", required: false },
      { key: "athleticism_score_rank", label: "Athleticism Score Rank", required: false },
      { key: "total_score", label: "Total Score", required: false },
      { key: "total_score_rank", label: "Total Score Rank", required: false },
    ],
    needsSource: false,
  },
  bleacher_profiles: {
  ...
  bio_data: {
    label: "Bio Data",
    description: "Import player bio info — height, weight, age, DOB, class/eligibility, games, snaps, position, college, projected round. Source must be one of the approved bio sources. Set Bio Priority to control which source wins when data conflicts.",
    requiredColumns: [
      { key: "player_name",     label: "Player Name",      required: true  },
      { key: "height",          label: "Height",           required: false },
      { key: "weight",          label: "Weight",           required: false },
      ...
      { key: "year",            label: "Year / Eligibility", required: false },
      { key: "games",           label: "Career Games",     required: false },
      { key: "snaps",           label: "Career Snaps",     required: false },
      { key: "position",        label: "Position",         required: false },
      { key: "college",         label: "College",          required: false },
      { key: "projected_round", label: "Projected Round",  required: false },
    ],
